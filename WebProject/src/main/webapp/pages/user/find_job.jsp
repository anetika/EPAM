                                            ...
                                            <tr class="inner-box">
                                                ...
                                                <td>
                                                    <form action="<c:url value="/Controller"/>" method="post">
                                                        <input type="hidden" name="command" value="go_to_write_feedback_command">
                                                        <input type="hidden" name="vacancy_id" value="${vacancy.id}">
                                                        <button type="submit" name="status" value="IRRELEVANT" class="btn btn-success">
                                                            ${find_job_writeFeedback}
                                                        </button>
                                                    </form>
                                                </td>
                                            </tr>

...
<c:set var="prev_page" value="${PagePath.GO_TO_ALL_IRRELEVANT_VACANCIES_PAGE_COMMAND}" scope="session"/>
                                            ...
                                            <tr class="inner-box">
                                                ...
                                                <td>
                                                    <form action="<c:url value="/Controller"/>" method="post">
                                                        ...
                                                        <button type="submit" name="status" value="RELEVANT" class="btn btn-success">
                                                                Approve
                                                        </button>
                                                    </form>
                                                </td>
